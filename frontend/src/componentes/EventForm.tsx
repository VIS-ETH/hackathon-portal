...
import { PatchEventMutationRequest, usePatchEvent, EventDto, eventPhase } from "@/api/gen";
            ...
            <IconDeviceFloppy />
                ...
                <Group grow>
                    ...
                    <Select
                        ...
                        data={[eventPhase.Registration, eventPhase.Hacking, eventPhase.Grading, eventPhase.Finished]}
                        label="Phase"
                    />
                                         <Stack>
                    <Switch
